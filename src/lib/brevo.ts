...
export async function getOrCreateNewsletterList(): Promise<number> {
    try {
        ...
        const newsletterList = lists.find((list) => list.name === "The Dev Jounal Newsletter")
        ...
        const newList = await createList("The Dev Jounal Newsletter")
        return newList.id
    } catch (error: any) {
...
export async function sendEmail({
                                    ...
                                    subject,
                                    htmlContent,
                                    sender = { name: "The Dev Journal", email: "TheDevJournal@protonmail.com" },
                                    params,
                                }: {
